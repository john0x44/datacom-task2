...
const AsideIndex = () => {
  const handleCountryClick = (countryCode) => {
    // Define latitude and longitude for Australia and New Zealand
    const coordinates = {
      au: { lat: 130, lng: -30 },
      nz: { lat: 174, lng: -40 }
    };
    const event = new CustomEvent("map.snapTo", {
      detail: coordinates[countryCode]
    });
  ...
  return (
    <>
      ...
      <List>
        <ListItem button onClick={() => handleCountryClick("au")}>
          <ListItemIcon>
            <Icon>
              <GiAustralia />
            </Icon>
        ...
        <ListItem button onClick={() => handleCountryClick("nz")}>
          <ListItemIcon>
            <Icon>
              <GiFern />
            </Icon>
